...
class Camera:
    ...
    def fix_coordinates(self) -> None:
        ...
        node = cast(
            ids_peak.BooleanNode | None, self.remote_device_nodemap.TryFindNode("ReverseY")
        )
    ...
    def start_acquisition(self) -> None:
        ...
        cast(
            ids_peak.IntegerNode, self.remote_device_nodemap.FindNode("TLParamsLocked")
        ).SetValue(1)
    ...
    def set_gain(self, gain_type: str, gain: float) -> None:
        ...
        cast(ids_peak.FloatNode, self.remote_device_nodemap.FindNode("Gain")).SetValue(
            float(gain)
        )
    ...
    def reset_to_default(self) -> None:
        ...
        cast(
            ids_peak.CommandNode, self.remote_device_nodemap.FindNode("UserSetLoad")
        ).Execute()
